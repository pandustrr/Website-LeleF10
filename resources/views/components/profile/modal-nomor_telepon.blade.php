<!-- Modal Nomor Telepon -->
<div id="modal-nomor_telepon" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-xl shadow-lg">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t border-gray-200">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="modal-nomor_telepon">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('profile.update', ['field' => 'nomor_telepon']) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div>
            ...
            <div class="flex items-center p-6 space-x-3 border-t border-gray-200 rounded-b">
                ...
                <button data-modal-hide="modal-nomor_telepon" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">
                    Batal
                </button>
                </form>
            </div>
